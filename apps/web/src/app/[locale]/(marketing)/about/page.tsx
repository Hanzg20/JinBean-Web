...
export default async function About(props: IAboutProps) {
  ...
  return (
    <div className="relative container mx-auto py-12 px-4 overflow-hidden rounded-xl border-4 border-cyan-400 shadow-2xl animate-glow bg-white/80 backdrop-blur-md">
      ...
      <h2 className="relative z-10 text-2xl font-semibold mt-8 mb-4 animate-fade-in animation-delay-500">
        我们的使命
      </h2>
      ...
      <h2 className="relative z-10 text-2xl font-semibold mt-8 mb-4 animate-fade-in animation-delay-1000">
        团队介绍
      </h2>
