      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl md:text-4xl font-bold text-[#2E8B57] mb-2">5,000+</div>
              <div className="text-gray-600">社区成员</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-[#FFD700] mb-2">1,200+</div>
              <div className="text-gray-600">互助帖子</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-[#B22222] mb-2">50+</div>
              <div className="text-gray-600">社区活动</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-[#4A90E2] mb-2">98%</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">邻里交流</h3>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">互助服务</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">社区活动</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">信息发布</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">评价推荐</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">积分奖励</h3>
              <p className="text-gray-600">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">推荐一位很棒的保洁阿姨</h3>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">免费提供园艺咨询</h3>
              <p className="text-gray-600 mb-4">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">中国传统文化工作坊</h3>
                <p className="text-gray-600 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">美食分享会</h3>
                <p className="text-gray-600 mb-4">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">音乐交流会</h3>
                <p className="text-gray-600 mb-4">
