...
export const newsData: NewsItem[] = [
  {
    ...
    content: {
      zh: `
        ...
        <img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=1200&q=80" alt="Smart Interaction" class="rounded-3xl my-10 shadow-lg border border-slate-100 dark:border-white/5" />

        <h3>1. 增强客户个性化体验</h3>
        <p>AI正在将POS终端从单一的刷卡工具转化为智能互动节点。通过集成人脸识别技术，AI可以识别回头客，并根据其消费历史提供个性化的推荐 and 奖励。此外，AI语音助手（类似于Siri）正被集成到POS系统中，引导客户完成自助结账，并即时回答产品相关问题。</p>

        <img src="https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?auto=format&fit=crop&w=1200&q=80" alt="Unmanned Retail" class="rounded-3xl my-10 shadow-lg border border-slate-100 dark:border-white/5" />
        ...
        <img src="https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=1200&q=80" alt="Data & Security" class="rounded-3xl my-10 shadow-lg border border-slate-100 dark:border-white/5" />
